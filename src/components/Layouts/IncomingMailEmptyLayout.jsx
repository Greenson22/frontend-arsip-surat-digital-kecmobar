...
const IncomingMailEmptyLayout = (props)=>{
     ...
     return (
          <div>
               ...
               <Card>
                    <CardHeader>
                         <TableAction title="Daftar surat masuk" button1="Tambah surat" button1_target="#add-mail-modal" button2="Ekspor" button2_target="#exportModal" button2Disabled={true}/>
                    </CardHeader>
                    <CardBody>
                         <TableFilter />
